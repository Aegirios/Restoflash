 ...
 */
final class Version20231121044510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipe_recipe_ingredient (recipe_id INT NOT NULL, recipe_ingredient_id INT NOT NULL, INDEX IDX_F09816B759D8A214 (recipe_id), INDEX IDX_F09816B73CAF64A (recipe_ingredient_id), PRIMARY KEY(recipe_id, recipe_ingredient_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE recipe_ingredient (id INT AUTO_INCREMENT NOT NULL, recipe_id INT DEFAULT NULL, ingredient_id INT DEFAULT NULL, INDEX IDX_22D1FE1359D8A214 (recipe_id), INDEX IDX_22D1FE13933FE08C (ingredient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipe_ingrediant (recipe_id INT NOT NULL, ingrediant_id INT NOT NULL, INDEX IDX_25D856CF59D8A214 (recipe_id), INDEX IDX_25D856CF8AEA29A (ingrediant_id), PRIMARY KEY(recipe_id, ingrediant_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
